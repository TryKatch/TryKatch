...
The coordinated release target is **Trykatch 0.1.0-preview.27**, retaining developer onboarding and including the opt-in, provider-neutral user-facing AI Help runtime and both React chat entry points. Publication requires successful exact-commit main CI and tag qualification; target metadata is not proof of publication. See the [release notes](releases/0.1.0-preview.27.md).
...
- Coordinated preview target: `0.1.0-preview.27`; the preceding published package is `0.1.0-preview.26` until successful publication.
