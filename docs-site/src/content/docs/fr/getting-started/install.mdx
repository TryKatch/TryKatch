...
Gardez Docker actif. Démarrez toujours l’AppHost — jamais le projet API seul — afin que PostgreSQL, les migrations, les identifiants d’exécution, l’API et React démarrent ensemble.
