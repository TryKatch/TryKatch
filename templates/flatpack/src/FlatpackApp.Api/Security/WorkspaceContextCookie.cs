...
{
    private const string CookieName = "__Host-flatpack-workspace";
    private readonly IDataProtector _protector = dataProtectionProvider.CreateProtector("FlatpackApp.WorkspaceContext.v1");
