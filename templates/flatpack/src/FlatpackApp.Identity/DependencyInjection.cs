...
{
    public static IServiceCollection AddFlatpackIdentity(this IServiceCollection services, IConfiguration configuration, bool isDevelopment, bool isOpenApiGeneration = false)
    {
        ...
        IDataProtectionBuilder dataProtection = services.AddDataProtection().SetApplicationName("FlatpackApp");
        ...
        {
            options.Cookie.Name = "__Host-flatpack";
        ...
        OpenIddictBuilder openIddict = services.AddOpenIddict()
            ...
            .AddServer(options =>
            {
                ...
                options.RegisterScopes(OpenIddictConstants.Scopes.OpenId, OpenIddictConstants.Scopes.Profile, "flatpack-api");
