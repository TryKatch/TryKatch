...
namespace FlatpackApp.Infrastructure.Modules.Storage;
...
{
    public static IServiceCollection AddFlatpackStorage(this IServiceCollection services, IConfiguration configuration)
    {
