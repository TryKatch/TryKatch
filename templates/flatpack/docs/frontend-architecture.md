...
Flatpack keeps reusable interface behavior in the smallest package that can own it.
...
- `apps/web/src/components` contains application-specific modules such as the role editor and Flatpack mark.
