...
import { Badge, Button, DataTable, DeleteConfirmationDialog, Dialog, EmptyState, FilterBar, PageHeader, RowActions, Skeleton, Surface, type DataTableColumn, type RowAction } from '@flatpackapp/ui'
    ...
    <div className="profile-stack">
      ...
      <Surface className="profile-card">
        ...
        <form className="profile-form password-grid" onSubmit={savePassword}>
          ...
          <label>Current password <span aria-hidden="true">*</span><input name="currentPassword" type="password" autoComplete="current-password" required /></label>
          <label>New password <span aria-hidden="true">*</span><input name="newPassword" type="password" autoComplete="new-password" minLength={12} required /></label>
          <label>Confirm new password <span aria-hidden="true">*</span><input name="confirmPassword" type="password" autoComplete="new-password" minLength={12} required /></label>
