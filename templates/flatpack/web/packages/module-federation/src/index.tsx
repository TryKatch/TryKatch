...
import { defineFlatpackWebModule } from '@flatpackapp/module-sdk'
import { Badge, Button, Dialog, EmptyState, PageHeader, PasswordField, Skeleton, Surface } from '@flatpackapp/ui'
...
export const federationModule = defineFlatpackWebModule({
  id: 'federation',
  name: 'Single sign-on',
  version: '1.0.0',
