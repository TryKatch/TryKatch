...
public sealed partial class ModuleWorkspace
{
    public ModuleDoctorReport EjectPackage(string moduleId, string sourceBundleRoot, string expectedManifestSha256)
    {
        ...
        string bundleManifestPath = Path.Combine(bundleRoot, "flatpack.module.json");
        ...
        string targetManifestPath = Path.Combine(dotnetTargetDirectory, "flatpack.module.json");
        ...
        try
        {
            ...
            AddProjectReference(ResolveInsideRoot("src/FlatpackApp.Api/FlatpackApp.Api.csproj"), dotnetTarget);
            AddProjectReference(ResolveInsideRoot("src/FlatpackApp.Migrator/FlatpackApp.Migrator.csproj"), dotnetTarget);
