...
export function UserManagementPage() {
  ...
  function submitInvite(event: FormEvent<HTMLFormElement>) { event.preventDefault(); const data = new FormData(event.currentTarget); invite.mutate({ email: String(data.get('email')), roleId: String(data.get('roleId')) }) }
