...
export function UserManagementPage() {
  ...
  const activeRoles = useQuery({ enabled: canReadRoles, queryKey: ['access-levels', 'active'], queryFn: () => customFetch<Role[]>('/api/v1/roles?lifecycle=active', { method: 'GET' }) })
