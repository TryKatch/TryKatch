...
internal static class ModuleMigrationExecutor
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        List<AppliedModuleMigration> applied = [];
        ...
        IReadOnlyList<PendingModuleMigration> pending =
            ModuleMigrationPlan.Build(enabledModules, applied);
        foreach (PendingModuleMigration migration in pending)
        {
