...
namespace Trykatch.AppHost;

internal static class ApplicationHostingExtensions
{
        ...
        this IDistributedApplicationBuilder builder)
    {
        ...
        IResourceBuilder<ParameterResource> organizationPassword =
            builder.AddParameter("organization-runtime-password", "local-organization-only", secret: true);
        IResourceBuilder<ParameterResource> platformPassword =
            builder.AddParameter("platform-runtime-password", "local-platform-only", secret: true);
        IResourceBuilder<ParameterResource> identityPassword =
            builder.AddParameter("identity-runtime-password", "local-identity-only", secret: true);
        ...
        IResourceBuilder<PostgresDatabaseResource> database = builder.AddApplicationDatabase(
            ...
            identityPassword,
            outboxPassword);
        IResourceBuilder<ContainerResource> collector = builder.AddOpenTelemetryCollector();
        IResourceBuilder<ProjectResource> api = builder.AddApplicationApi(
            database,
            collector,
            migratorPassword,
            organizationPassword,
    ...
    private static IResourceBuilder<ContainerResource> AddOpenTelemetryCollector(
        this IDistributedApplicationBuilder builder) =>
        builder
    ...
    private static IResourceBuilder<ProjectResource> AddApplicationApi(
        this IDistributedApplicationBuilder builder,
    ...
    private static void AddDevelopmentEmail(
        this IDistributedApplicationBuilder builder,
        ...
        if (builder.ExecutionContext.IsRunMode)
        {
            IResourceBuilder<ContainerResource> mailpit = builder
                .AddContainer(
                    "mailpit",
                    "axllent/mailpit",
                    "v1.30.4@sha256:5a49a77c5bdbe7c5474450b4f46348d09949df3695257729c93a30369382d4f6")
    ...
    private static void AddObservabilityStack(this IDistributedApplicationBuilder builder)
    {
        builder
            .AddContainer(
                "loki",
                "grafana/loki",
                "3.7.2@sha256:191d4fdfb7264f16989f0a57f320872620a5a7c2ceeec6229212c4190ec49b86")
        ...
        builder
            .AddContainer(
                "tempo",
                "grafana/tempo",
                "3.0.2@sha256:cda87c212d8c584dc0b89e337e7ed648a5100feb657e5d528480ee4fa03dbbe3")
        ...
        builder
            .AddContainer(
                "prometheus",
                "prom/prometheus",
                "v3.14.0@sha256:5ce7540c3c00ef4ab0c9d2c995c6a5b9c421f44b4a115d97a2c7af3b1c21cbb0")
            .WithBindMount(
        ...
        builder
            .AddContainer(
                "grafana",
                "grafana/grafana",
                "13.2.1@sha256:f772d434e8fab0049deb2b1b30abd43342bcfca1537614aa8d36080232cf4283")
            .WithBindMount(
