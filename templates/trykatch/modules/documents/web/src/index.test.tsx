...
import { defineTrykatchWebModule, TrykatchModuleProvider, TrykatchWebModuleCatalog } from '@trykatchapp/module-sdk'
import { cleanup, fireEvent, render, screen, waitFor } from '@testing-library/react'
import type { ReactNode } from 'react'
import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest'
import { DocumentsPage, documentsModule } from './index'

vi.mock('@trykatchapp/api-client', () => ({ customFetch: vi.fn() }))
...
const projectsModule = defineTrykatchWebModule({
...
const catalog = new TrykatchWebModuleCatalog([projectsModule, documentsModule])
...
function workspace(client: QueryClient, children: ReactNode) {
  return (
    <QueryClientProvider client={client}>
      <TrykatchModuleProvider catalog={catalog}>{children}</TrykatchModuleProvider>
    </QueryClientProvider>
  )
}
