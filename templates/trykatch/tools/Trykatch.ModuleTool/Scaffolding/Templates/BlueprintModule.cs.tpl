...
public sealed class __MODULE__Module : IModule, IModuleMigrationContributor
{
    ...
    [
        new("202601010000_initial", """
            ...
            (
                ...
                "WorkflowState" character varying(64) NOT NULL,
    ...
    public void Register(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<__ENTITY__ReadModel>();
        services.AddScoped<List__ENTITY__QueryHandler>();
        services.AddScoped<Get__ENTITY__QueryHandler>();
        services.AddScoped<Create__ENTITY__CommandHandler>();
        services.AddScoped<Update__ENTITY__CommandHandler>();
        services.AddScoped<__ENTITY__RecoveryCommands>();
        __ACTION_REGISTRATIONS__
    }
}
