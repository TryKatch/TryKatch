...
CI runs the same contract on every pull request and branch build. Tagged releases additionally require the tag, such as `v0.1.0-preview.21`, to match `RELEASE_VERSION`; publication fails before packing when they differ.
