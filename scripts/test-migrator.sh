...
export TRYKATCH_STORAGE_SERVICE_URL=http://object-storage.invalid
export TRYKATCH_STORAGE_ACCESS_KEY=storage-test-access-key
export TRYKATCH_STORAGE_SECRET_KEY=storage-test-secret-key
